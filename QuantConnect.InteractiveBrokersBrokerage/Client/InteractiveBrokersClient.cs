...
namespace QuantConnect.Brokerages.InteractiveBrokers.Client
{
    ...
    public class InteractiveBrokersClient : DefaultEWrapper, IDisposable
    {
        ...
        /// <summary>
        /// Tape top-of-book/bid-ask price event handler
        /// </summary>
        public event EventHandler<TapeBidAskEventArgs> TapeBidAsk;
        ...
        /// <summary>
        /// Tape top-of-book data callback.
        /// See https://ibkrcampus.com/ibkr-api-page/twsapi-doc/#receive-tick-data
        /// </summary>
        /// <param name="reqId">The request's unique identifier.</param>
        /// <param name="tickType">0: “Last” or 1: “AllLast”.</param>
        ...
        {
            // Console.WriteLine("tickByTickBidAsk!!!  Request Id: {0}, TickType: BidAsk, Time: {1}, BidPrice: {2}, AskPrice: {3}, BidSize: {4}, AskSize: {5}, BidPastLow: {6}, AskPastHigh: {7}",
                // reqId, time, bidPrice, askPrice, bidSize, askSize, tickAttribBidAsk.BidPastLow, tickAttribBidAsk.AskPastHigh);
            OnTapeBidAskData(new TapeBidAskEventArgs(reqId, time, bidPrice, askPrice, bidSize, askSize));
        }
        ...
        /// TODO: given tape speed/bandwidth, maybe skip EventArgs alltogether and pass args skipping the wrapper object?
        /// </summary>
        protected virtual void OnTapeBidAskData(TapeBidAskEventArgs e)
        {
            TapeBidAsk?.Invoke(this, e);
        }
